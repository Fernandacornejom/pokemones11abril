...
--consulta con alias
SELECT pokedex AS numero FROM pokemones WHERE nombre = 'eevee';
INSERT INTO mis_pokemones(pokedex, fecha_captura, lugar, huevo, peso, estatura)
VALUES (133, '2021-04-12', 'puente alto', false, 15.6, 8.3);
INSERT INTO mis_pokemones (pokedex,fecha_captura,lugar, huevo, peso, estatura)
VALUES (134, '2021-04-12', 'puente alto', false, 24.6, 0.8);

SELECT * FROM mis_pokemones ORDER BY fecha_captura DESC;
...
SELECT tipo1, COUNT(*) FROM pokemones GROUP BY tipo1;
 -- ejecutar consola con order by fat shaming
